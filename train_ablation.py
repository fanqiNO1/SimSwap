...
from models_ablation.projected_model import fsModel
...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--total_step", type=int, default=200000, help='total training step')
        ...
        self.parser.add_argument("--model_freq", type=int, default=100000, help='frequence for saving the model')

        # for ablation experiments
        self.parser.add_argument('--ablationG', type=str, default='', 
                                help='ablation experiments in netG , available: no_conv, no_bottleneck, no_upsample')
        self.parser.add_argument('--loss', type=str, default='L1',
                                help='loss function, available: L1, L2')
        self.parser.add_argument('--ablationD', type=int, default=2,
                                help='ablation experiments in netD, available: 0, 1, 2')
