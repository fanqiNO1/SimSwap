...
from pg_modules_ablation.projected_discriminator import ProjectedDiscriminator
...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        # Generator network
        self.netG = Generator_Adain_Upsample(input_nc=3, output_nc=3, latent_size=512, n_blocks=9, deep=opt.Gdeep, ablation=opt.ablationG)
        self.netG.cuda()
        ...
        if not self.isTrain:
            ...
            return
        self.netD = ProjectedDiscriminator(diffaug=False, interp224=False, opt=opt, **{})
