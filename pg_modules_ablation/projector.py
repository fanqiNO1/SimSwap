...
import timm
from pg_modules_ablation.blocks import FeatureFusionBlock
...
class F_RandomProj(nn.Module):
    ...
    def forward(self, x, get_features=False):
        ...
        if self.proj_type == 0: return backbone_features, backbone_features
        ...
        if self.proj_type == 1: return out, backbone_features
