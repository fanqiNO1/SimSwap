...
from pg_modules_ablation.blocks import DownBlock, DownBlockPatch, conv2d
from pg_modules_ablation.projector import F_RandomProj
from pg_modules_ablation.diffaug import DiffAugment
...
class ProjectedDiscriminator(torch.nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.proj_type = opt.ablationD
        self.feature_network = F_RandomProj(proj_type=self.proj_type, **backbone_kwargs)
